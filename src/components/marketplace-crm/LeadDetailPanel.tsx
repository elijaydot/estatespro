  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
        ...
        <Card>
          <CardHeader className="pb-3"><div className="flex items-start justify-between gap-3"><div><CardTitle className="flex items-center gap-2 text-base"><Clock3 className="h-4 w-4" />Activity Timeline</CardTitle><CardDescription>Full contact and internal activity trace.</CardDescription></div><Button size="sm" variant="ghost" onClick={() => { setActivityTypeFilter('all'); setActivityDateFrom(''); setActivityDateTo(''); setActivityRegisterOpen(true); }}>View all ({activities.length})</Button></div></CardHeader>
